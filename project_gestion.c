...
void ajout_etud(){
    ...
    sprintf(etud.password + strlen(etud.password), "%d", 2024);
...
void chercher_infos(char nom[]){
	...
	F=fopen("etudiant.txt","r");
			   ...
			   while (fscanf(F,"%d ;%s ;%s ;%d ;%s \n",&etud.Num,&etud.Nom,&etud.Prenom,&etud.niveau,&etud.password) ==5){
			            ...
			            if(strcmp(etud.Nom ,nom)==0){printf("\t\t\t----------------------------------------------------------------\n");
...
void supprimer() {
    ...
    printf("Entrer le Num d'inscription de l'etudiant :\n");
    scanf("%d", &num);
...
void affich_list(){
    ...
    for (int i = 0; i < j; i++) {
        ...
        while (fscanf(F, "%d ;%s ;%s ;%d ;%s \n", &etud.Num, etud.Nom, etud.Prenom, &etud.niveau, etud.password) == 5) {
            if (arr[i] == etud.Num) {
                printf("\t\t\t-%d\t\t%d\t\t\t%s\t%s \n", i + 1, etud.Num, etud.Nom, etud.Prenom);
                printf("\t\t\t---------------------------------------------------------------------\n");
            }
        }
        ...
        yy:printf("\t\t\t   ---Entrer le num d inscription de l etudiant :");
        	scanf("%d",&num);
            	if(recherch_num(num)!=0){
	                ...
	                printf("\t\t\t----------------------------------------------------------------------\n");
                	printf("\t\t\t--------- Tu vas remplire les notes de touts les etudiants   ----------\n");
                    printf("\t\t\t----------------------------------------------------------------------\n");
                    printf("\t\t\t----------------------------------------------------------------------\n");
...
void affiche_mat(int niv){
	FILE *F;
	F=fopen("matiere.txt","r");
	 printf("\t\t\t----------------------------------------------------------------\n");
	     printf("\t\t\t----------------------------------------------------------------\n");
    printf("\t\t\t------------------ les matieres de semestre %d -----------------\n",niv);
     printf("\t\t\t----------------------------------------------------------------\n");
    printf("\t\t\t----------------------------------------------------------------\n\n");
	while(fscanf(F,"%d ;%s ;%d ;%s \n",&mat.Num,&mat.matiere,&mat.niveau)==3){
	  if(niv==mat.niveau)printf("\t\t\t---%d) %s \n",mat.Num,mat.matiere);
	}
	fclose(F);
printf("\t\t\t----------------------------------------------------------------\n");
 printf("\t\t\t----------------------------------------------------------------\n\n\n");
...
void voir_emploi_de__temps(int num_etu){
    ...
    f=fopen("emploi.txt","r");
    printf("\t\t\t----------------------------------------------------------------\n");
    printf("\t\t\t------------------ Voila votre emploi du temps ------------------\n");
    printf("\t\t\t----------------------------------------------------------------\n\n");
...
void affiche_matiere(int num){
	...
	f=fopen("etudiant.txt","r");
	 printf("\t\t\t----------------------------------------------------------------\n");
	     printf("\t\t\t----------------------------------------------------------------\n");
    printf("\t\t\t------------------ Voila votre table de matiere -----------------\n");
     printf("\t\t\t----------------------------------------------------------------\n");
    printf("\t\t\t----------------------------------------------------------------\n\n");
...
void interface_admin(){
    printf("\t\t\t----------------------------------------------------------------\n");
	printf("\t\t\t----------------------------------------------------------------\n");
    printf("\t\t\t------------------ Bienvenu Dans Votre Espace -------------------\n");
    printf("\t\t\t----------------------------------------------------------------\n");
    printf("\t\t\t----------------------------------------------------------------\n");
    ...
    printf("\t\t\t----------- [6]: pour enregistrer l absencee         -----------\n");
...
int main(){
    ...
    printf("     -------------------------------------------------------------------------------------------------------------\n");
	printf("     -------------------------------------------------------------------------------------------------------------\n");
	printf("     --------------------------- BIENVENU DANS L APPLICATION DE GESTION DES ETUDIANTS ----------------------------\n");
	printf("     -------------------------------------------------------------------------------------------------------------\n");
	printf("     -------------------------------------------------------------------------------------------------------------\n\n");
	printf("        \t\t\t\t\t\t---login---\n\n");
	printf("\t\t\t\t\t-Entrer votre nom         : ");scanf(" %s",&nom_etd);
	printf("\t\t\t\t\t le mot de pass est de format prenom + 2024\n\t\t\t\t\t-Entrer votre mot de pass :");scanf(" %s",&pass);
	...
	d:scanf("%d",&i);
	 ...
	 else if(i==5){system("cls");inserer_note();e:printf("\t\t\t\t\t\t--- Retour(0) --- ");scanf("%d",&n);if(n==0)goto c;else goto e;
	 }
	...
	w:scanf("%d",&i);
	 if(i==1){system("cls");chercher_infos(nom_etd);bb:printf("\t\t\t\t\t\t--- Retour(0) --- ");scanf("%d",&n);if(n==0)goto x;else goto bb;
	 }
